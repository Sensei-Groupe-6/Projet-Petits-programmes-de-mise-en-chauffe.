...
# Base de données ou les élements du dictionnaire
	...
	book = File.read("data/shakespeare.txt")
	banned = File.read("data/banned.txt").split("\n")

# Tester avec des chaînes de mots et le livre que l'on a télécharger
describe "#day_trader" do

	# test avec des textes simple
		it " " do
